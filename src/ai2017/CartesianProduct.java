...
public class CartesianProduct {
    ...
    public static List<List<CriterionFeatures>> calculateCFW(List<CriterionFeaturesWeight> input) {
        List<List<CriterionFeatures>> list1= new ArrayList<>();
        for (CriterionFeaturesWeight criterionFeaturesWeight : input) {
            list1.add(criterionFeaturesWeight.getCriterionFeatures());
        }
